...
class SpawnManyModel:
    ...
    def spawn_model(self, model_name):
        for index in range(24):
            ...
            self.initial_pose.position.x = exp2_obj_pose[o][0]
            self.initial_pose.position.y = exp2_obj_pose[o][1]
            self.initial_pose.position.z = exp2_obj_pose[o][2]
            roll = exp2_obj_pose[o][3]
            pitch = exp2_obj_pose[o][4]
            yaw = exp2_obj_pose[o][5]
